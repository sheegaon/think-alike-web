...
export default function WaitingRoom() {
	...
	// Get correct player count and minimum players
	const currentPlayerCount = game.room?.currentPlayers || 0
	const minPlayers = game.room?.minPlayers || 4
	const stake = game.room?.stake || 0
	const pot = currentPlayerCount * stake
